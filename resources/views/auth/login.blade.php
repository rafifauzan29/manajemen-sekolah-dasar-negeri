    ...
    <div class="relative bg-white bg-opacity-90 rounded-lg shadow-lg p-6 sm:p-8 max-w-md w-full mx-auto z-10">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4 sm:mb-5">
                <label for="email" class="block text-gray-700 mb-1 sm:mb-2 font-medium text-sm sm:text-base">Email</label>
                <input
                    id="email"
                    name="email"
                    type="email"
            ...
            <div class="mb-5 sm:mb-6">
                <label for="password" class="block text-gray-700 mb-1 sm:mb-2 font-medium text-sm sm:text-base">Kata Sandi</label>
                <input
                    id="password"
                    name="password"
                    type="password"
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 text-sm sm:text-base">
